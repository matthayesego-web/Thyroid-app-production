...
- medication name, dose, usual time, and dose-change history
- medication status logs
- symptom and wellbeing check-ins
- optional context tags and weight
...
Thyroid Echo can create patient-entered text summaries and PDF reports on the device. A report leaves the app only when you explicitly choose to share it using Android's sharing interface. Once you share a report to another app or service, that destination's privacy practices apply.
...
A public Thyroid Echo support/privacy contact address will be added before the closed beta/public Play listing is submitted for review.
